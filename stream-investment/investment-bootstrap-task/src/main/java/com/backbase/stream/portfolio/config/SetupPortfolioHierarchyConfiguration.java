...
public class SetupPortfolioHierarchyConfiguration {
    ...
    void execute() {
        ...
        data.setClientUsers(
            List.of(
                ClientUser.builder().externalUserId("alex").internalUserId("16122eb4-8aa9-428b-b1e8-d760befbae68").build(),
                ClientUser.builder().externalUserId("naomi").internalUserId("39002c12-db15-44a1-a95c-0b9777e4ff73").build(),
                ClientUser.builder().externalUserId("ddd").internalUserId("ea02c250-87db-4dfc-a6b7-1c0a615a6d89").build(),
                ClientUser.builder().externalUserId("bbbbb").internalUserId("ea02c250-87db-4dfc-a6b7-1c0a615a6d90").build()
        ));
